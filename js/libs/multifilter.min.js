    ...
    u.ConfigCallbacks.registerAction('afterConstruct', 'multifilter', function () {
      ...
      i.extend(u.FilterGroup.prototype, {
          ...
          l &&
            (((o = e.mixer.config.selectors.control) && !l.matches(o)) ||
              ...
              ('function' == typeof t.config.callbacks.onMixClick &&
                ((r = t.config.callbacks.onMixClick.call(t.lastClicked, t.state, u, e)), r === !1)) ||
                (l.matches('[data-filter]')
                  ...
                  : l.matches('[data-toggle]') &&
                    ...
                    (e.activeFilters = []),
                    (n = e.activeToggles.indexOf(E)) > -1 ? e.activeToggles.splice(n, 1) : e.activeToggles.push(E),
                    'and' === e.logic
        ...
        handleFormEvent: function (e) {
          ...
          if (
            ...
            'reset' === e.type && ((t.activeFilters = t.activeToggles = t.activeSelectors = []), t.updateControls()),
            t.mixer.multifilterFormEventTracker)
          )
            i = t.mixer.multifilterFormEventTracker
          else
            for (
              i = t.mixer.multifilterFormEventTracker = new u.MultifilterFormEventTracker(), i.form = e.target, l = 0;
          ...
          e.target === i.form &&
            ...
            i.totalHandled === i.totalBound &&
              ...
              ('submit' !== e.type && 'change' !== t.mixer.config.multifilter.parseOn) || t.mixer.parseFilterGroups()))
        },
      ...
      u.Mixer.extend({
          ...
          for (r = 0; (i = e.dom.filterGroups[r]); r++)
            if (((t = new u.FilterGroup()), t.init(i, e), e.filterGroups.push(t), t.name)) {
              if ('undefined' != typeof e.filterGroupsHash[t.name])
                throw new Error('[MixItUp MultiFilter] A filter group with name "' + t.name + '" already exists')
        ...
        setFilterGroupSelectors: function (u, e) {
          var t = this,
            i = null
          if (((e = Array.isArray(e) ? e : [e]), 'undefined' == typeof (i = t.filterGroupsHash[u])))
            throw new Error('[MixItUp MultiFilter] No filter group could be found with the name "' + u + '"')
